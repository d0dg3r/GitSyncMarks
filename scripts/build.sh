...
if [[ -n "${RELEASE:-}" ]]; then
  ...
  DISPLAY_VERSION="${MANIFEST_VERSION}-dev"
fi
...
# Write lib/display-version.js (must export getAppVersion for options.js)
write_display_version() {
  local target_file="$1"
  local display_val="${2:-}"
 ...
 * Generated by scripts/build.sh — do not edit in build output.
 */
export const DISPLAY_VERSION = '${display_val}';
 ...
 * Generated by scripts/build.sh — do not edit in build output.
 */
export const DISPLAY_VERSION = null;
...
build_chrome() {
  ...
  write_display_version "$chrome_dir/lib/display-version.js" "$DISPLAY_VERSION"
...
build_firefox() {
  ...
  # Display version for GUI: pre-release tag or null (use manifest)
  write_display_version "$firefox_dir/lib/display-version.js" "$DISPLAY_VERSION"
