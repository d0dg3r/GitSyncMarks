...
> [!TIP]
> **Try GitSyncMarks 3.0 (beta)** — upcoming multi-provider sync and related features are in the **v3.0 pre-release** only. Download the latest beta from [GitHub Releases (pre-releases)](https://github.com/d0dg3r/GitSyncMarks/releases?q=pre) — currently **[v3.0.0-beta.7](https://github.com/d0dg3r/GitSyncMarks/releases/tag/v3.0.0-beta.7)**.
>
...
> - **Nested-card UI** — clearer grouped sections in Files, wizard, popup, and search (beta.7)
...
- **Install beta**: **[v3.0.0-beta.7](https://github.com/d0dg3r/GitSyncMarks/releases/tag/v3.0.0-beta.7)** — Load unpacked / temporary add-on (see beta box above).
...
- **Chrome/Edge/Brave**: Download **[v3.0.0-beta.7](https://github.com/d0dg3r/GitSyncMarks/releases/tag/v3.0.0-beta.7)** ZIP, extract, **Load unpacked** in `chrome://extensions/` (Developer Mode).
