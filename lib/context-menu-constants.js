...
// Use chrome namespace if available (supports callbacks in Firefox MV3), fallback to browser
export const browserObj = typeof chrome !== 'undefined' ? chrome : (typeof browser !== 'undefined' ? browser : undefined);
