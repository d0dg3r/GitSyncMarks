 ...
 */
export function buildSwitchPushChanges(localFiles, lastSyncFiles, bitwardenBackupPath) {
  ...
  const diff = computeDiff(
    filterForDiff(baseContentMap, bitwardenBackupPath),
    filterForDiff(localFiles, bitwardenBackupPath)
  );
  const fileChanges = {};
 ...
 */
export function buildStaleBasePushChanges(
  remoteDiff,
  localFiles,
  remoteFiles,
  isIgnoredPath,
  ...
  const liveDiff = computeDiff(
    filterForDiff(remoteFiles, bitwardenBackupPath),
    filterForDiff(localFiles, bitwardenBackupPath)
  );
