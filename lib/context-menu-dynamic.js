...
/**
 * @param {boolean} ready - Set `false` before `removeAll`; `true` after all static `contextMenuCreateAsync` calls have settled, before the dynamic pass.
 */
 ...
 */
export function contextMenuCreateAsync(createProperties) {
