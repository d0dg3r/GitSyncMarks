...
export class GitHubAPI {
  ...
  constructor(tokenOrOptions, owner, repo, branch = 'main') {
    ...
    this.providerId = GIT_PROVIDERS.GITHUB;
  }

  /** @returns {string} */
  _apiBase() {
    try {
      return resolveApiBase(GIT_PROVIDERS.GITHUB, this.serverUrl);
    } catch {
  ...
  /** @returns {string} */
  webBaseUrl() {
    return resolveWebBaseUrl(GIT_PROVIDERS.GITHUB, this.serverUrl);
  }
