...
Sync favoris vers votre dépôt Git. Linkwarden, Smart Search, Companion App. Direct, sécurisé, privé.

### Detailed Description
GitSyncMarks synchronise vos favoris de manière bidirectionnelle avec votre propre dépôt Git — grandes plateformes hébergées et serveurs Git auto-hébergés. Gérez vos données sur bureau via Chrome et Firefox, ou en mobilité avec l'application GitSyncMarks Companion. Aucun intermédiaire, aucun serveur tiers – contrôle et confidentialité totaux.
...
- Automatisation : Ajoutez des favoris via CLI ou GitHub Actions ; l'extension les intègre au prochain sync.
...
Utilisez GitSyncMarks-App (Android, iOS, Bureau) pour gérer vos favoris directement depuis votre dépôt Git sur mobile.
