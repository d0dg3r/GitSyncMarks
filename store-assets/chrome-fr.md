...
GitSyncMarks synchronise vos favoris de manière bidirectionnelle avec votre propre dépôt Git — grandes plateformes hébergées et serveurs Git auto-hébergés. Gérez vos données sur bureau dans votre navigateur, ou en mobilité avec l'application GitSyncMarks Companion. Aucun intermédiaire, aucun serveur tiers – contrôle et confidentialité totaux.
...
Utilisez GitSyncMarks-App (mobile et bureau) pour gérer vos favoris directement depuis votre dépôt Git.
