...
**Reviewer note (3.0.3):** Description and permission justifications updated so that no field lists more than five platform names; the full list of supported Git hosts is linked to docs/PROVIDERS.md and is visible in the connection screenshot. No functional change.
