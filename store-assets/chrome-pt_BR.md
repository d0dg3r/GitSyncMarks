...
Sync de favoritos para seu repositório Git. Linkwarden, Smart Search, Companion App. Direto, seguro, privado.

### Detailed Description
GitSyncMarks sincroniza seus favoritos bidirecionalmente com seu próprio repositório Git — grandes plataformas hospedadas e servidores Git auto-hospedados. Gerencie seus dados no desktop no seu navegador, ou em movimento com o GitSyncMarks Companion App. Sem intermediários, sem servidores de terceiros – controle e privacidade totais.

Destaques

- Sync Git multi-provedor: Conecte seu host Git ou servidor auto-hospedado — cada perfil usa seu próprio provedor e URL. Lista completa de provedores: https://github.com/d0dg3r/GitSyncMarks/blob/main/docs/PROVIDERS.md
...
- Backup compatível com Bitwarden para Git: Armazene exportações de cofre protegidas por senha no seu repo, criptografia extra opcional; listar, baixar ou excluir backups remotos.
...
App complementar
Use o GitSyncMarks-App (móvel e desktop) para gerenciar seus favoritos diretamente do seu repositório Git.
