...
Git 저장소로 북마크 동기화. Linkwarden, Smart Search, Bitwarden 백업, 안내 마법사. 양방향, 안전, 프라이빗. 완전한 Firefox 지원. 중개자 없음.

### Detailed Description
GitSyncMarks는 북마크를 자체 Git 저장소와 양방향 동기화합니다 — 주요 호스팅 플랫폼 및 self-hosted Git 서버. 중개자 없음, 제3자 서버 없음 – 데이터는 완전히 사용자의 통제 하에 있습니다.
...
동반 앱
GitSyncMarks-App(모바일 및 데스크톱)으로 Git 저장소의 북마크를 직접 관리. (참고: Firefox for Android는 확장 프로그램을 통한 직접 북마크 동기화를 지원하지 않습니다 – 앱을 사용하세요.)
