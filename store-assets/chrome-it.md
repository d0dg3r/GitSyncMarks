...
• Onboarding: browser di cartelle per selezionare il percorso di sync; crea cartella o importa segnalibri durante la configurazione di un nuovo profilo
...
• Compagno mobile: GitSyncMarks-App (iOS + Android) — consulta i tuoi segnalibri ovunque, sync in sola lettura dal tuo repository
