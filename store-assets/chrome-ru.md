...
• Мобильный компаньон: GitSyncMarks-App (iOS + Android) — просматривайте закладки на ходу, Sync только для чтения из вашего репозитория
...
Мобильное приложение: GitSyncMarks-App (iOS + Android) — закладки на ходу. Только чтение; F-Droid и Google Play скоро. https://github.com/d0dg3r/GitSyncMarks-App
