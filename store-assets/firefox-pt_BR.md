...
App complementar
Use o GitSyncMarks-App (móvel e desktop) para gerenciar seus favoritos diretamente do seu repositório Git. (Nota: Firefox para Android não suporta sync direta de favoritos via extensões – use o app.)
