...
App complementaria
Use GitSyncMarks-App (móvil y escritorio) para gestionar sus marcadores directamente desde su repositorio Git. (Nota: Firefox para Android no soporta sync directa de marcadores vía extensiones – use la app.)
