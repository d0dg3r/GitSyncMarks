...
Sync marcadores a su repositorio Git. Linkwarden, Smart Search, backup Bitwarden, asistente guiado. Bidireccional, seguro, privado. Soporte Firefox completo. Sin intermediarios.

### Detailed Description
GitSyncMarks sincroniza sus marcadores bidireccionalmente con su propio repositorio Git — grandes plataformas alojadas y servidores Git autohospedados. Sin intermediarios, sin servidores de terceros – sus datos permanecen completamente bajo su control.
...
- Optimizado para Firefox: Soporta estructuras nativas (Barra de herramientas, Menú, Otros).
...
App complementaria
Use GitSyncMarks-App (Android, iOS, Escritorio) para gestionar sus marcadores directamente desde su repositorio Git en dispositivos móviles. (Nota: Firefox para Android no soporta sync directa de marcadores vía extensiones – use la app.)
...
### Tags
marcadores, sync, github, gitlab, backup, automatización
