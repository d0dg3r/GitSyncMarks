...
• Начальная настройка: браузер папок для выбора пути синхронизации; создание папки или загрузка закладок при настройке нового профиля
...
• Мобильное приложение: GitSyncMarks-App (iOS + Android) — просматривайте закладки в пути, только чтение из вашего репозитория
...
Мобильное приложение: GitSyncMarks-App (iOS + Android) — закладки в пути. Только чтение; F-Droid и Google Play скоро. https://github.com/d0dg3r/GitSyncMarks-App
