...
GitHub, GitLab, Codeberg, Gitea 등으로 북마크 동기화. Linkwarden, Smart Search, Companion App.

### Detailed Description
GitSyncMarks는 GitHub, GitLab, Codeberg, Gitea, Forgejo 또는 Gogs와 북마크를 양방향 동기화합니다. Chrome과 Firefox 데스크톱 또는 GitSyncMarks Companion App으로 모바일에서 관리. 중개자 없음, 제3자 서버 없음 – 완전한 제어와 프라이버시.
