...
북마크를 GitHub에 안전하게 보관 — 파일별 저장, 3방향 병합 동기화, Chrome 및 Firefox 지원. 중개자 없음.

### Detailed Description
GitSyncMarks는 브라우저 북마크를 GitHub 리포지토리와 동기화합니다 — 양방향, 자동, 중개자 없음.
...
• 온보딩: 폴더 브라우저로 동기화 경로 선택; 새 프로필 구성 시 폴더 생성 또는 북마크 Pull
