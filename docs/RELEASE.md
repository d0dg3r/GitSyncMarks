...
|---|---|---|
| `2.7.3` | *Spock* | Cursor MCP docs: empty committed [`.cursor/mcp.json`](.cursor/mcp.json); reference `mcpServers` JSON in [docs/TESTING.md](docs/TESTING.md); user-wide `~/.cursor/mcp.json` vs project file + duplicate-avoidance; [CONTRIBUTING.md](CONTRIBUTING.md), [docs/ARCHITECTURE.md](docs/ARCHITECTURE.md) |
